...
<head>
  ...
  <title>Class Manager — Iniciar Sesión | UTS</title>
...
<body>
  <div class="login-wrapper">
    <div class="login-card">
      ...
      <h1 class="login-heading">Class Manager</h1>
      ...
      <div id="panel-register" class="panel-hidden">
        <form onsubmit="doRegister(event)">
          <div class="form-group" style="text-align: left;">
            ...
            <input type="text" class="form-control" id="matricula-reg" name="matricula" required
              placeholder="Docente o Alumno">
          </div>
      ...
      fetch('index.php?action=register', { method: 'POST', body: formData })
        ...
        .then(data => {
          ...
          if (data.success) {
            ...
            document.getElementById('username').value = mat;
